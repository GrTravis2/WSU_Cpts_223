...
main: main.o
	g++ -std=c++11 -g TestHashMap.o TestSinglyLinkedList.o InventoryQueryTool.o ArgParse.o TestArgParse.o main.o -o PA4

main.o: TestHashMap.o TestSinglyLinkedList.o InventoryQueryTool.o ArgParse.o TestArgParse.o
